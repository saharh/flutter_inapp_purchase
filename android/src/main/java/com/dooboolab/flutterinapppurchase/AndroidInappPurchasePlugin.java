...
//            public void onSkuDetailsResponse(int responseCode, List<SkuDetails> skuDetailsList) {
         ...
         */
            ...
            if (responseCode == BillingClient.BillingResponseCode.OK && purchaseDataList != null) {
...
//                                              List<Purchase> purchasesList) {
                public void onPurchaseHistoryResponse(
                    ...
                    if (purchaseHistoryRecordList != null && responseCode == BillingClient.BillingResponseCode.OK) {
...
//                item.put("transactionId", purchase.getOrderId()); // doesnt exist?
...
//                if (type.equals(BillingClient.SkuType.SUBS)) {
//                  item.put("autoRenewingAndroid", purchase.isAutoRenewing()); // doesnt exist?
//                }
         ...
         */
            ...
            mBillingClient.querySkuDetailsAsync(params.build(),
                    new SkuDetailsResponseListener() {
                        @Override
                        public void onSkuDetailsResponse(BillingResult br1, List<SkuDetails> skuDetailsList) {
                            int responseCode = br1.getResponseCode();
                            if (responseCode != BillingClient.BillingResponseCode.OK || skuDetailsList.isEmpty()) {
                                result.error(TAG, "buyItemByType", "billingResponse is not ok or list is empty: " + responseCode);
                                return;
                            }
                            ...
                            BillingResult br2 = mBillingClient.launchBillingFlow(reg.activity(), flowParams);
                            responseCode = br2.getResponseCode();
                            if (responseCode != BillingClient.BillingResponseCode.OK) {
